...
ciudad,pais,region,codigo_postal,
telefono,linea_direccion1,
linea_direccion2 
from oficina;

select codigo_oficina, ciudad from oficina;

/* RETO 2 -Retorna un listado con la ciudad y el teléfono de 
...
/* RETO 3 -Retorna un listado con el nombre, apellidos y email
...
/* RETO 5 -Retorna un listado con el nombre, apellidos y puesto de
...
telefono,fax,linea_direccion1,
linea_direccion2,ciudad,region,
...
/* RETO 7 -Retorna un listado con los distintos estados por los que 
...
/* RETO 9 -Genera un listado con el código de pedido, código de cliente, 
fecha esperada y fecha de entrega de los pedidos que no han sido entregados a tiempo.*/

describe pedido;

select codigo_pedido,
fecha_pedido,fecha_esperada,
fecha_entrega,estado,comentarios,
codigo_cliente from pedido;

select codigo_pedido,codigo_cliente,fecha_esperada,fecha_entrega,estado from pedido where estado = "Rechazado";

/* RETO 10 -Genera un listado con el código de pedido, código de cliente, 
...
select estado,fecha_entrega from pedido where year(fecha_entrega) = 2009 and estado = "Rechazado";
...
select fecha_entrega, estado, codigo_pedido from pedido
...
select forma_pago
from pago where forma_pago in ('Transferencia', 'Cheque', 'PayPal')
group by forma_pago;
...
cantidad_en_stock,
precio_venta,
precio_proveedor from producto;
...
select region, codigo_empleado_rep_ventas from cliente
